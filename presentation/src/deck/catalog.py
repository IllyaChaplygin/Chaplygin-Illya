...
SUPPLIERS = [
    dict(
        ...
        extra_section=dict(
            ...
            title='Arare Norimaki — рітейл і BULK',
            scenario='Контейнер везе рітейл-фасовку разом із BULK 3 кг',
            products=[
        ...
        scenario='Контейнер везе тільки рітейл-фасовку',
    ...
    dict(
        ...
        cert_label='Позначки якості на упаковці',
        certs=['tn_mark_gluten', 'tn_mark_cholesterol', 'tn_mark_organic',
               'tn_mark_gmo', 'tn_mark_vegan'],
        extra_section=dict(
            sheet='Thai-Nichi - Retail+Bulk',
            title='Norimaki — рітейл і BULK',
            scenario='Контейнер везе рітейл-фасовку разом із BULK 2,5 кг',
            products=[
    ...
    dict(
        ...
        cert_docs=['tmk_cert_gmp', 'tmk_cert_haccp', 'tmk_cert_halal',
                   'tmk_cert_iso22000', 'tmk_cert_fssc22000', 'tmk_cert_codex'],
        cert_captions=['GMP', 'HACCP', 'Halal', 'ISO 22000', 'FSSC 22000', 'CODEX'],
        stats=[('2011', 'рік заснування\nкомпанії'),
               ('13+', 'країн\nекспорту'),
               ('$10 млн+', 'експорт\nза шість років')],
        scenario='Розрахунок на контейнер із рітейл-фасовкою',
        logo='logo_kokiri',
